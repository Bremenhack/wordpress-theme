# BremenHack Late 2017
The Wordpress Theme for BremenHack. Basend on FoundationPress.
Please install [Advanced Custom Fields](https://www.advancedcustomfields.com/).


# Readme taken from FoundationPress
